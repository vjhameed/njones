  ...
  <div class="row">
      <div class="col-md-6 col-md-offset-3 text-center">
          <div class="form-group selectlist">
              <label id='select-label'>Select Workshop:</label>
              <select id="userchoice" class="form-control">
        <option value='0'>Select a Workshop...</option>
        <option value='1'>Buisness Workshop</option>
  ...
  <div class="container carousel-container">
                  ...
                  <div class="carousel-inner" role="listbox">
                          ...
                          <div class="row">
                              <div class="col-md-6 text-center carouselcols">
                                  <div class="textcontext">
                                      <h2>Welcome to ION's Writing a Simple Business Plan Workshop!!!</h2>
                                  </div>
                              </div>
                              <div class="col-md-6 text-center carouselcols">
                      ...
                      <div class="item">
                          <div class="row">
                              <div class="col-md-6 text-center carouselcols">
                                  <div class="textcontext">
                                      <h2>The Workshop is structured into 3 segmens with breaks and question and answer periods throughout the workshop. You will need pen, notebook and an open mind.</h2>
                                  </div>
                              </div>
                              <div class="col-md-6 text-center carouselcols">
                                  <img src="sitefront/avatar.png">
                      ...
                      <div class="item">
                          <div class="row">
                              <div class="col-md-6 text-center carouselcolsfull">
                                  <div class="textcontext">
                                      <h4>Which words you believe are used to define a Business Plan?</h4>
                      ...
                      <div class="item">
                          <div class="row">
                              <div class="col-md-6 text-center carouselcols">
                                  <div class="textcontext">
                                      <h3>Why do you believe a Business Plan is important?</h3>
                                  </div>
                              </div>
                              <div class="col-md-6 text-center carouselcols">
                                  <img src="sitefront/avatar.png">
                      ...
                      <div class="item">
                          <div class="row">
                              <div class="col-md-6 text-center carouselcols">
                                  <div class="textcontext">
                                      <h3>A Business Plan helps inform others of your plan and maps out strategies and goals for your company.</h3>
                                  </div>
                              </div>
                              <div class="col-md-6 text-center carouselcols">
                                  <img src="sitefront/avatar.png">
                      ...
                      <div class="item">
                          <div class="row">
                              <div class="col-md-6 text-center carouselcols">
                                  <div class="textcontext">
                                      <h3>Icebreaker: On your first sheet of paper, take a quick moment to draft a business card. Include the following information:</h3>
                                      <ul class="list-group">
                                          <li class="list-group-item">Your (Aspiring) Comapny's Name</li>
                                          <li class="list-group-item">Your Slogan (Description of what you do in 4 words or less)</li>
                                          <li class="list-group-item">Your Name (or Founder's Name)</li>
                              ...
                              <div class="col-md-6 text-center carouselcols">
                                  <div class="textcontext">
                                      <ul class="list-group">
                                          <li class="list-group-item">Position Title Company</li>
                                          <li class="list-group-item">Mailing Address</li>
      ...
      <div class="row">
          <div class="col-md-offset-2 col-md-8 col-sm-12">
              <button class="btn btn-default btn-lg custombtn btn-primary" id="btnprev" style="float-left;">Previouse</button>
              <button class="btn btn-default btn-lg custombtn btn-primary" id="btnnext" style="float:right;">Next</button>
          </div>
      </div>
  </div>
